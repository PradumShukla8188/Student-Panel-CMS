            ...
            <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center mt-5">
                ...
                >
                    ...
                    <p className="mt-4  leading-relaxed">
                        Established in <span className="font-semibold text-teal-400">2019</span>,
                        our institute has been dedicated to delivering high-quality education in
                        <span className="font-semibold text-teal-400"> basic to advanced computer courses</span>.
                        We focus on practical learning, strong fundamentals, and real-world skills
                        that empower students to build successful careers.
                    </p>

                    <p className="mt-4  leading-relaxed">
                        From beginners exploring computers for the first time to advanced learners
                        diving into professional IT training, we ensure every student receives
                        personal attention, structured training, and industry-oriented knowledge.
                    </p>
